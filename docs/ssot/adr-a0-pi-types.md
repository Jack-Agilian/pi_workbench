...
日期：2026-09-22。范围：A0/A1 收尾。依据为用户本轮继续完成类型阻塞修复的指令；仅允许下述类型声明修正，不授权整仓 Fork、运行时代码修改或放宽检查。状态：已采用并通过限定回归，见 [实际被测提交与收尾证据](../validation/a0-a1-closeout-2026-09-22.md)。
